...
///=================================================
   ...
   fil2=fopen("./efsf2b.csv","a+");
   fil3=fopen("./param2b.txt","a+");
   //fprintf(fil2,"mbase, Deltam, FWHM, Tmax, fws, frac, rho, tstar, ur,  fb,  mstar, limb\n");
   ...
   double tstar, u, tim, Astar, tmm, thre, dt; 
   double u0, tE, rho, fb,  mstar, fli, limb; 
   double twing,  tshol, fws,  mbase,  magm, FWHM, magm2;
   int flag2, flag1, N, error; 
   ...
   limb = double((double)rand()/(double)(RAND_MAX+1.))*0.35+0.35;
   vbb.a1=limb; 
   ...
   flag1=flag2=0; 
   maxm1=tmax1=0.0; 
   FWHM=tim1=tim2=magm=magm2=0.0; 
   twing=tshol=fws=fli=0.0; 
 ...
 ///*****************************************************************************************
   ...
   mbase, fabs(magm), fabs(FWHM), fabs(tmax1), fws, fli, rho, tstar, u0/rho, fb, mstar, limb);}
    
    
  
   fprintf(fil3,
   "%d  %.6lf  %.6lf %.6lf %.6lf  %.6lf  %.6lf %.6lf  %.6lf  %.6lf  %.6lf  %.6lf %.6lf  %.6lf  %.6lf  %.6lf  %.6lf  %.6lf %d  %d\n",
   ...
   cout<<"limb:  "<<limb<<"\t magm2:  "<<magm2<<"\t fli:  "<<fli<<endl;
